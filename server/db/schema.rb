...
ActiveRecord::Schema[8.1].define(version: 2026_04_09_102000) do
  ...
  create_table "coupons", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.float "minimum_booking_amount"
    t.datetime "updated_at", null: false
  ...
  create_table "tickets", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["show_id", "seat_id"], name: "index_tickets_on_show_id_and_seat_id_valid", unique: true, where: "((status)::text = 'valid'::text)"
