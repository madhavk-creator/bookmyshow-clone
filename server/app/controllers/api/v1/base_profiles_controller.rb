module Api
  module V1
    class BaseProfilesController < ApplicationController
      ...
      def update
        result = run ::Users::UpdateProfile, params: profile_params,
          expected_role: expected_role do |operation_result|
      ...
      def update_password
        result = run ::Users::UpdatePassword, params: password_update_params,
          expected_role: expected_role do |operation_result|
            return render json: operation_result[:response_data], status: :ok
        end
      ...
      def password_update_params
        password_payload.permit(:current_password, :password, :password_confirmation)
      ...
      def extract_payload(*keys)
        ...
        payload.is_a?(ActionController::Parameters) ? payload : ActionController::Parameters
          .new(payload)
      end
