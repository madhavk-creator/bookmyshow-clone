module ShowSeatStates
  class Block < ::Trailblazer::Operation
    ...
    def authorize_block(ctx, current_user:, **)
      return true if Pundit.policy!(current_user, ::ShowSeatState).block?

      ctx[:errors] = { base: [ "Not authorized to block seats" ] }
      false
    end
